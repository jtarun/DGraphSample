...
public class App {
  ...
  //private static final String TEST_HOSTNAME = "10.79.139.81";
  ...
  public static void main(String[] args) {
    ...
    DGraphRepository dGraphRepository = new DGraphRepository(dgraphClient);
    dGraphRepository.createUser(new User(2000, "pwd", "abc", "def", "abc@thoughtspot.com"));

    //dGraphRepository.getUser("tLuke11 Skywalker");
  }
